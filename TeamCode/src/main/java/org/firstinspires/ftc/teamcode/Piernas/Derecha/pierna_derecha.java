...
public class pierna_derecha extends SubsystemBase {
    ...
    public pierna_derecha(HardwareMap hardwareMap, Telemetry telemetry) {
        ...
        rodilla.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        rodilla.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        rodilla.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        //pie
        pie = hardwareMap.get(DcMotorEx.class, "pie");
        pie.setZeroPowerBehavior(DcMotorEx.ZeroPowerBehavior.BRAKE);
        pie.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        pie.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        //levantar
        //1
    ...
    public void periodic() {
        ...
        telemetry.addData("rodilla", rodilla.getCurrentPosition());
        telemetry.addData("pie", pie.getCurrentPosition());
        telemetry.update();
    }
}